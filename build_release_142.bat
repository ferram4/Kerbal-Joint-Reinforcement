...
copy "GameData\KerbalJointReinforcement\KerbalJointReinforcement_1.4.2.version" "_release\GameData142\GameData\KerbalJointReinforcement\KerbalJointReinforcement.version"
...
copy "KerbalJointReinforcement\KerbalJointReinforcement\bin\Release 1.4.2\KerbalJointReinforcement_Redist.dll" "_release\GameData142\GameData\KerbalJointReinforcement\Plugins\KerbalJointReinforcement_Redist.dll"
...
C:\PACL\PACOMP.EXE -a -r -p "_release\KerbalJointReinforcement_v3.4.0_for_1.4.2.zip" "_release\GameData142\*"
