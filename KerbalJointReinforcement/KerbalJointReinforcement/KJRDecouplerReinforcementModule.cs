...
namespace KerbalJointReinforcement
{
    ...
    public class KJRDecouplerReinforcementModule : PartModule
    {
        ...
        private void AddExtraJoints()
        {
            ...
            {
                if (p == null || p.GetComponent<Rigidbody>() == null || p.Modules.Contains("ProceduralFairingDecoupler") || !KJRJointUtils.JointAdjustmentValid(p))
                    continue;
                foreach (Part q in childParts)
                {
                    if (q == null || q.GetComponent<Rigidbody>() == null || q.Modules.Contains("ProceduralFairingDecoupler") || p == q || !KJRJointUtils.JointAdjustmentValid(q))
                        continue;
        ...
        {
            Rigidbody rigidBody = partConnectedByJoint.GetComponent<Rigidbody>();
